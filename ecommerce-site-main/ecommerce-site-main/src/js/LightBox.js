...
const LightBox = () => {
  ...
  const firstImage = () => {
    setImage(Images[1]);
    document.querySelector(".image2").style.boxShadow = "0 0 0 3px orange";
  ...
  const secondImage = () => {
    setImage(Images[2]);
    document.querySelector(".image3").style.boxShadow = "0 0 0 3px orange";
    document.querySelector(".image1").style.boxShadow = "none";
  ...
  const thirdImage = () => {
    setImage(Images[3]);
    document.querySelector(".image4").style.boxShadow = "0 0 0 3px orange";
    document.querySelector(".image1").style.boxShadow = "none";
    document.querySelector(".image2").style.boxShadow = "none";
    document.querySelector(".image3").style.boxShadow = "none";
    document.querySelector(".image1").style.filter = "none";
  ...
  const fourthImage = () => {
    setImage(Images[0]);
    document.querySelector(".image1").style.boxShadow = "0 0 0 3px orange";
    document.querySelector(".image2").style.boxShadow = "none";
    document.querySelector(".image3").style.boxShadow = "none";
    document.querySelector(".image4").style.boxShadow = "none";
